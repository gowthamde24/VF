...
5
Water Pump
Irrigation Cycle (5 min/hr)
2
6
Grow Lights
Day/Night Cycle (06:00-20:00)
3
13
Fan
Cooling (if Temp > 25°C)
4
19
pH Down Pump
Acid Dosing (if pH > 6.5)
5
26
pH Up Pump
Base Dosing (if pH < 5.5)
6-8
-
Expansion
Nutrient Dosing / Spares
...
Keep main.py running (it generates dashboard.json).
